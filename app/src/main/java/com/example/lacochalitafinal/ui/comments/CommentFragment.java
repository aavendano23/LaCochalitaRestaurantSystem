...
import com.example.lacochalitafinal.Adapter.MyCommentAdapter;
import com.example.lacochalitafinal.Callback.ICommentCallbackListener;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        commentViewModel.getMutableLiveDataFoodList().observe(this, new Observer<List<CommentModel>>() {
            ...
            public void onChanged(List<CommentModel> commentModels) {
                MyCommentAdapter adapter = new MyCommentAdapter(CommentFragment.this.getContext(), commentModels);
